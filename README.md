# Red Flag Tarot — Reality Check Detector
...
> **Tagline:** Ứng dụng Tarot thực tế giúp nhận diện tín hiệu bất ổn (Red Flags), bóc tách động cơ ngầm và bảo vệ ranh giới cá nhân trong các mối quan hệ.
...
- **Gắn thẻ tín hiệu nghi ngờ (Quick Tags):**
  - Ghosting (Biến mất đột ngột)
  - Love bombing (Dồn dập tấn công tình cảm)
  - Gaslighting / Nói một đằng làm một nẻo
  - Thất hứa về tài chính / công việc
- **Ghi chú cá nhân:** Ô nhập tự do 1 câu ngắn gọn mô tả sự việc gây bất an.
...
- **Tương tác trực quan:**
  ...
  - Tự động ghi nhận chiều xuôi (Upright) và ngược (Reversed).
...
└── assets/
    └── images/
          ...
          |   ├── Major_Arcana/          #(22p) chiều xuôi thứ tự lẫn hình ảnh mặt lá       
          |   └── Minor_Arcana/          #(56p) chiều xuôi thứ tự lẫn hình ảnh mặt lá
          |             ├── Cups/         (14p) 
          |             ├── Pentacles/    (14p) 
          |             ├── Swords/       (14p)
          |             └── Wands/        (14p)
